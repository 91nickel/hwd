...
| 13.12 | [Числовые типы данных, арифметика](13.12-chislovye-tipy-dannyh-arifmetika.md) | int, float, type(), %, **, //, round, +=, -= | [задания](tasks/13.12/) |
| 13.13 | Готовимся программулькать | Без текстового контента | — |
| 13.14 | [🔥ПРОГРАММУЛЬКАЕМ! Первая настоящая программа](13.14-programmulkaem-pervaya-programma.md) | input() возвращает str, int() приводит к числу, вложенный вызов int(input()) | [задания](tasks/13.14/) |
| 13.15 | [Нецелые числа](13.15-netsely-chisla.md) | float неточен в двоичном представлении; decimal и fractions для точных вычислений | [задания](tasks/13.15/) |
| 13.16 | [🔥ПРОГРАММУЛЬКАЕМ! Расчёт обоев](13.16-programmulkaem-raschet-oboev.md) | Decimal + math.ceil/floor: три версии программы расчёта рулонов обоев | — |
